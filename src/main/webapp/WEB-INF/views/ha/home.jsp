...
<meta charset="UTF-8">
<title>home ha</title>
<link rel='stylesheet' href='../resources/css/test_content.css'> </head>
<body>
<%@ include file="header.jsp"%>	<div id="side_list">
    ...
    </div><div id='btns'>	<input type='button' value='저장' id='save' data-tv='ha'>
	<input type='button' value='삭제' id='remove' data-tv='ha'>
	<input type='button' value='불러오기' id='load' data-tv='ha'>
</div>

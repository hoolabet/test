...
<link rel="stylesheet"
	href="../resources/css/test_footer_controller.css">
</head>
<body>
	<div id="entry">
		...
		<div id="footer">
			<div id="footer_1" class="footer" data-target="1"
				style="width: 100%; height: 200px; background-color: #e3e3e3; margin: auto">
			</div>
		</div>

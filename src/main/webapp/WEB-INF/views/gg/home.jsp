...
<%@ include file="header.jsp"%>	<div id="side_list">
    ...
    </div><div id='btns'>	<input type='button' value='저장' id='save' data-tv='gg'>
	<input type='button' value='삭제' id='remove' data-tv='gg'>
	<input type='button' value='불러오기' id='load' data-tv='gg'>
</div>
